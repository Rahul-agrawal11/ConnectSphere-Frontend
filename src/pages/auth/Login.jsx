...
export default function Login() {
  ...
  const [error, setError] = useState(
    oauthError === 'oauth2' ? 'OAuth2 sign-in failed. Please try again.' : ''
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Backend returns ApiResponse<T> → err.response.data.message
    ...
    <div className="auth-page">
      <div className="auth-shell">
        ...
        <div className="auth-card">
          ...
          {/* OAuth2 Buttons
              FIX: Spring Security OAuth2 path is /oauth2/authorization/{provider}
                   NOT /oauth2/authorize/{provider}
              The browser navigates directly (not via axios) so the gateway
              handles the redirect to the provider. */}
          <div className="oauth-grid">
            <a
              href={GOOGLE_OAUTH_URL}
              className="oauth-button"
            >
              <svg className="oauth-button__icon" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="oauth-button"
            >
              <svg className="oauth-button__icon" fill="currentColor" viewBox="0 0 24 24">
